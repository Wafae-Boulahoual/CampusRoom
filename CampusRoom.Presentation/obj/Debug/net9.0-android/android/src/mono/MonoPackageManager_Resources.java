...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "CampusRoom.Presentation.dll" comes first in this list. */
		"CampusRoom.Presentation.dll",
		"DnsClient.dll",
		"GoogleGson.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"CampusRoom.Application.dll",
		"CampusRoom.Infrastructure.dll",
		"Domain.Models.dll",
